...
testCase('testCase 18',A,B,0,1,reportEvaluateFatalMistake) :-
    reportCreate(G0),
    reportCheck(G0,c08,A),
    reportCheck(G0,c14,B).

testCase('testCase 19',A,B,0,1,reportRule24) :-
    reportCreate(G0),
    reportCheck(G0,c01,G1),
    reportCheck(G1,c02,B),
    reportCheck(G0,c09,A).

testCase('testCase 20',A,B,100,1,reportRule21) :-
    reportCreate(G0),
    reportCheck(G0,c01,B),
    reportCheck(G0,c12,G1),
    reportCheck(G1,c13,A).

testCase('testCase 21',A,B,25,1,reportRule22) :-
    reportCreate(B),
    reportCheck(B,c01,G0),
